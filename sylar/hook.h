...
typedef int (*connect_fun)(int sockfd,
...
typedef ssize_t (*sendto_fun)(int s,
                              const void* msg,
                              size_t len,
                              int flags,
...
typedef int (*getsockopt_fun)(int sockfd,
                              int level,
                              int optname,
                              void* optval,
                              socklen_t* optlen);
...
typedef int (*setsockopt_fun)(int sockfd,
                              int level,
                              int optname,
                              const void* optval,
                              socklen_t optlen);
...
extern int connect_with_timeout(int fd,
                                const struct sockaddr* addr,
                                socklen_t addrlen,
                                uint64_t timeout_ms);
}
