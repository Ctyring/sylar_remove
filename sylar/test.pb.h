...
#ifndef GOOGLE_PROTOBUF_INCLUDED_sylar_2ftest_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_sylar_2ftest_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_sylar_2ftest_2eproto
...
struct TableStruct_sylar_2ftest_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sylar_2ftest_2eproto;
namespace test {
class Hello;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::test::Hello* Arena::CreateMaybeMessage<::test::Hello>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace test {
...
class Hello final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:test.Hello) */ {
 public:
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_sylar_2ftest_2eproto;
};
// ===================================================================
...
// optional string name = 1;
inline bool Hello::_internal_has_name() const {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_sylar_2ftest_2eproto
