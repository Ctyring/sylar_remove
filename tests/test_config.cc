...
sylar::ConfigVar<std::list<int>>::ptr g_int_list_value_config =
    sylar::Config::Lookup("system.int_list",
                          std::list<int>{1, 2},
                          "system int list");

sylar::ConfigVar<std::set<int>>::ptr g_int_set_value_config =
    sylar::Config::Lookup("system.int_set",
                          std::set<int>{1, 2},
                          "system int set");

sylar::ConfigVar<std::unordered_set<int>>::ptr g_int_uset_value_config =
    sylar::Config::Lookup("system.int_uset",
...
void test_yaml() {
    YAML::Node root =
        YAML::LoadFile("/home/sylar/workspace/sylar/bin/conf/log.yml");
    // print_yaml(root, 0);
...
#define XX_M(g_var, name, prefix)                                          \
    ...
    YAML::Node root =
        YAML::LoadFile("/home/sylar/workspace/sylar/bin/conf/test.yml");
